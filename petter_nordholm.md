...
- **Applikations- och webbservrar:** Apache, Jetty, Weblogic, JBoss, Glassfish, IIS
...
- **Komponentramverk:** Spring, OSGI, Java EE, 
...
** Presentation, språk, produktionsledning, koordinering, UML modellering Rational Rose …  

**Nyckelord:**	Java, C++, CORBA, Perl, Unix, HPUX, Oracle, Solaris
...
Resultatet av arbetet resulterade i ett visionsdokument samt ett flertal kravspecifikationer mot utvecklingsorganisationen.
...
SDP, stora installtioner upp till 200 kluster, skalar vertikalt, hög konstnad för lansering av kampanjer hos operatörer pga. konfigurering av enskilda kluster under maintenance fönster.
...
Policy lösning igår som en nyckelkomponent i charging system / SDP. 
...
I projektet jobbade jag med alla delar inom deras poker system, både klienter, server och backoffice system.
...
På GMS har jag jobbat i ett geografiskt distribuerat team med medlemmar både inom och utanför sverige enligt Scrum. Arbetet på GMS bestod av att utveckla integrationslösningar för olika speloperatören och spelsystemet. 
...
På IST jobbade jag i ett team som hade fullt ansvar att leverera en valmodul till *School* systemet. I modul ingick utveckling av både administrative funktioner för att hantera val samt ett publikt API och en student portal.

I uppdraget lärde jag mig mycket kring utveckling av responsiva weblösningar där mycket fokus låg på tillgänglighet för alla.

**Nyckelord:** Spring, Java, Tomcat, Hibernate, Bootstrap, Angular, Aria

### Konsult - Monitoryourfleet
